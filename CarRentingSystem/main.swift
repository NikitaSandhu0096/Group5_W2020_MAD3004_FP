...
// Bus objects
var b1 = Bus(identificationNumber: "B01", description: "JBL enabled",manufacturerName: "Benz", isSelfDrive: false, isInsured: true, insuranceProviderName: "Orient", vehicleNoOfSeats: 20, fuelType: "Diesel", baseRatePerDay: 20, ratePerKm: 3, busType: "Volvo", iswifiAvailable: true, isAccessibiltyServiceAvailable: true)
var b2 = Bus(identificationNumber: "B02", description: "Customer-focused bifurcated group ware", manufacturerName: "Mercedes", isSelfDrive: false, isInsured: true, insuranceProviderName: "TruSheild", vehicleNoOfSeats: 24, fuelType: "Diesel", baseRatePerDay: 10 , ratePerKm: 2, busType: "Double Decker", iswifiAvailable: true, isAccessibiltyServiceAvailable: true)
var b3 = Bus(identificationNumber: "B03", description: "Focused actuating help-desk", manufacturerName: "Benz", isSelfDrive: false, isInsured: true, insuranceProviderName:"Peter", vehicleNoOfSeats: 18, fuelType: "Diesel", baseRatePerDay: 15, ratePerKm: 4.5, busType: "diesel", iswifiAvailable: false, isAccessibiltyServiceAvailable: true)
var b4 = Bus(identificationNumber: "B04", description: "Customer-focused bifurcated", manufacturerName: "Mercedes", isSelfDrive: false, isInsured: true, insuranceProviderName: "MR.Yonge", vehicleNoOfSeats: 45, fuelType: "Diesel", baseRatePerDay: 30, ratePerKm: 5, busType: "School Bus", iswifiAvailable: false, isAccessibiltyServiceAvailable: true)
var b5 = Bus(identificationNumber: "B05", description: "Customer-focused bifurcated", manufacturerName: "Benz", isSelfDrive: false, isInsured: true, insuranceProviderName: "Orient", vehicleNoOfSeats: 20, fuelType: "Diesel", baseRatePerDay: 22, ratePerKm: 5, busType: "City Transit", iswifiAvailable: true, isAccessibiltyServiceAvailable: false)
...
// Car objects
var c1 = Car(identificationNumber: "C01", description: "Sedan", isSelfDrive: false, manufacturerName: "Polo", isInsured: true, vehicleNoOfSeats: 4, insuranceProviderName: "National", seat: 4, fuelType: "Petrol", ratePerDay: 10, ratePerKm: 5, carColor: "White", carType: "Sedan")
